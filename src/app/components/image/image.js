class Image {
  ...
  puttingImage(src2) {
    if (
      document.querySelector('#buttonPeople').getAttribute('isactive') ===
      'true'
    ) {
    ...
    if (
      document.querySelector('#buttonVehicles').getAttribute('isactive') ===
      'true'
    ) {
      if (document.querySelector('#img')) {
        this.removeImg();
    ...
    if (
      document.querySelector('#buttonStarships').getAttribute('isactive') ===
      'true'
    ) {
      if (document.querySelector('#img')) {
        this.removeImg();
  ...
  addListeners(src2) {
    document
      ...
      .addEventListener('click', () => this.puttingImage(src2));
    document
