class MainMenu {
  ...
  creatingButtonContainer(name) {
    ...
    document
      ...
      .insertBefore(
        mainMenuContainer,
        document.querySelector('.gameArea').firstChild,
      );
  }
  ...
  puttingCorrectColor() {
    ...
    isActivePeople === 'true'
      ? (buttonPeople.style.color = '#000')
      : (buttonPeople.style.color = '#e6e6e6');
    isActiveVehicle === 'true'
      ? (buttonVehicles.style.color = '#000')
      : (buttonVehicles.style.color = '#e6e6e6');
    isActiveStarships === 'true'
      ? (buttonStarships.style.color = '#000')
      : (buttonStarships.style.color = '#e6e6e6');
  }
